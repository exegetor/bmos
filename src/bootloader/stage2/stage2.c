...
//		printf("                       ");
	...
	if (!fd) {
		ERROR("FAT12_fopen(/test.txt) failed\r\n");
	}
	else {
		INFO("Opened text.txt/  position= %u, size= %u\r\n", fd->position, fd->size);
	}
